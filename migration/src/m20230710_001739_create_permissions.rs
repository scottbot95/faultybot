...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(Permission::Id).integer().auto_increment().primary_key().not_null())
                    ...
                    .col(ColumnDef::new(Permission::Effect)
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.drop_type(Type::drop().name(Effect::Table).to_owned()).await
    }
}
