...
impl SettingsManager {
    ...
    pub async fn set_guild<T: serde::Serialize>(&self, guild_id: GuildId, key: String, value: T) -> Result<(), Error> {
        ...
        let model = entities::guild_settings::ActiveModel {
        ...
        entities::guild_settings::Entity::insert(model)
            .on_conflict(sea_orm::sea_query::OnConflict::new()
                .update_column(entities::guild_settings::Column::Value)
                .to_owned())
